            ...
            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(
                            mContext, R.layout.custom_select_dialog_multichoice, R.id.text1, mItems) {
                        @Override
